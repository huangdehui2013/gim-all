...
public final class AckReqClass {
  ...
  public  static final class AckReq extends
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return AckReqClass.internal_static_AckReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AckReqClass.AckReq.class, AckReqClass.AckReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AckReqClass.AckReq)) {
        return super.equals(obj);
      }
      AckReqClass.AckReq other = (AckReqClass.AckReq) obj;
    ...
    public static AckReqClass.AckReq parseFrom(
    ...
    public static AckReqClass.AckReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AckReqClass.AckReq parseFrom(
    ...
    public static AckReqClass.AckReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AckReqClass.AckReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static AckReqClass.AckReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AckReqClass.AckReq prototype) {
    ...
    public static final class Builder extends
      ...
      public AckReqClass.AckReq getDefaultInstanceForType() {
        return AckReqClass.AckReq.getDefaultInstance();
      }

      public AckReqClass.AckReq build() {
        AckReqClass.AckReq result = buildPartial();
      ...
      public AckReqClass.AckReq buildPartial() {
        AckReqClass.AckReq result = new AckReqClass.AckReq(this);
        result.ack_ = ack_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AckReqClass.AckReq) {
          return mergeFrom((AckReqClass.AckReq)other);
        } else {
      ...
      public Builder mergeFrom(AckReqClass.AckReq other) {
        if (other == AckReqClass.AckReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AckReqClass.AckReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AckReqClass.AckReq) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final AckReqClass.AckReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AckReqClass.AckReq();
    }

    public static AckReqClass.AckReq getDefaultInstance() {
