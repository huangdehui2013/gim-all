...
import static org.gogym.getty.handler.ssl.SslUtils.DEFAULT_CIPHER_SUITES;
import static org.gogym.getty.handler.ssl.SslUtils.PROTOCOL_SSL_V2;
import static org.gogym.getty.handler.ssl.SslUtils.PROTOCOL_SSL_V2_HELLO;
import static org.gogym.getty.handler.ssl.SslUtils.PROTOCOL_SSL_V3;
import static org.gogym.getty.handler.ssl.SslUtils.PROTOCOL_TLS_V1;
import static org.gogym.getty.handler.ssl.SslUtils.PROTOCOL_TLS_V1_1;
...
import static org.gogym.getty.handler.ssl.SslUtils.TLSV13_CIPHERS;
import static org.gogym.getty.handler.ssl.SslUtils.TLSV13_CIPHER_SUITES;
import static org.gogym.getty.handler.ssl.SslUtils.addIfSupported;
import static org.gogym.getty.handler.ssl.SslUtils.isTLSv13Cipher;
import static org.gogym.getty.handler.ssl.SslUtils.useFallbackCiphersIfDefaultIsEmpty;
