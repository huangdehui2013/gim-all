...
public class ServerBootstrap extends
	...
	public ServerBootstrap childHandler(ChannelHandler childHandler) {
		this.childHandler = ObjectUtil.checkNotNull(childHandler,
				"childHandler");
		return this;
	}
	...
	private static class ServerBootstrapAcceptor extends
		...
		ServerBootstrapAcceptor(final Channel channel,
			...
			// as otherwise the URLClassLoader may
			// not be able to load the class because of the file limit it
			// already reached.
			//
