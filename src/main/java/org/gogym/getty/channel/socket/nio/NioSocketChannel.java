 ...
 * under the License.
 */
package org.gogym.getty.channel.socket.nio;

import static org.gogym.getty.channel.internal.ChannelUtils.MAX_BYTES_PER_GATHERING_WRITE_ATTEMPTED_LOW_THRESHOLD;
...
import org.gogym.getty.channel.socket.SocketChannelConfig;
...
/**
 * {@link org.gogym.getty.channel.socket.SocketChannel} which uses NIO selector based implementation.
 */
public class NioSocketChannel extends AbstractNioByteChannel implements org.gogym.getty.channel.socket.SocketChannel {
